...
public class DownloaderThread extends Thread{
	 ...
	 * AndroidFileDownloader activity of changes in state. Writes the file
	 * of the root of the SD card.
	 */
	@Override
	public void run() {
		URL url;
		...
		try {
			...
			String errMsg = parentActivity.getString(
					R.string.error_message_bad_url);
			msg = Message.obtain(parentActivity.activityHandler,
					PublicacoesGUI.MESSAGE_ENCOUNTERED_ERROR,
					0, 0, errMsg);
			parentActivity.activityHandler.sendMessage(msg);
